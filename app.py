...
conn = sqlite3.connect('inventory_database1.db', check_same_thread=False)
c = conn.cursor()
...
img = get_img_as_base64("images/11.jpg")

img1 = get_img_as_base64("images/11.jpg")


page_bg_img = f"""
<style>
[data-testid="stAppViewContainer"] {{
background-image: url("data:11/png;base64,{img1}");
...
background-image: url("data:11/png;base64,{img}");
...
if source_radio == settings.IMAGE:
    ...
    st.markdown('<style>div[data-testid="stImageCaption"] { font-family: Times, sans-serif; color: #080808; font-size: 20px; }</style>', unsafe_allow_html=True)

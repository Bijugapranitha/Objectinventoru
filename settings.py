...
VIDEO4_PATH = VIDEO_DIR / 'video5.mp4'
VIDEO5_PATH = VIDEO_DIR / 'video4.mp4'
VIDEO6_PATH = VIDEO_DIR / 'video6.mp4'
VIDEO7_PATH = VIDEO_DIR / 'video7.mp4'
VIDEO8_PATH = VIDEO_DIR / 'video8.mp4'
VIDEO9_PATH = VIDEO_DIR / 'video9.mp4'
VIDEO10_PATH = VIDEO_DIR / 'video10.mp4'
...
DETECTION_MODEL2 = MODEL_DIR / 'SHAMPOOS8.pt'
